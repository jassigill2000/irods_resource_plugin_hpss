...
def get_build_prerequisites_yum():
    return ['krb5-devel', 'openssl-devel'] + get_build_prerequisites_all()
...
def install_build_prerequisites_yum():
    ...
    irods_python_ci_utilities.make_symbolic_link_as_root('/hpss_src/hpss-7.4.3.2-0.el6', '/opt/hpss')
...
def main(output_root_directory, irods_packages_root_directory):
    ...
    build_directory = tempfile.mkdtemp(prefix='irods_hpss_plugin_build_directory')

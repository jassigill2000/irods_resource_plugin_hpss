...
class Test_Compound_with_HPSS_Resource(unittest.TestCase, ResourceSuite, ChunkyDevTest):
    ...
    my_test_resource = {
        "setup"    : [
            ...
            "iadmin mkresc archiveResc hpss "+hostname+":/irodsVault keytab=/var/hpss/etc/irods.keytab;user=irods;mech=unix",
